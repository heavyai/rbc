...
service Heavy {
  ...
  list<string> get_udf_names(1: TSessionId session) throws (1: TDBException e)
  list<string> get_runtime_udf_names(1: TSessionId session) throws (1: TDBException e)
  list<extension_functions.TUserDefinedFunction> get_udf_details(1: TSessionId session, 2: list<string> udf_names) throws (1: TDBException e)
}