...
HeavyDB Bytes represents the following structure:
...
__all__ = ['BytesPointer', 'Bytes', 'HeavyDBBytesType']
...
class HeavyDBBytesType(HeavyDBBufferType):
    """HeavyDB Bytes type for RBC typesystem.
    """
