...
def test_table_function_manager(omnisci):
    omnisci.require_version((5, 8), 'Requires omniscidb-internal PR 5440')

    @omnisci('int32(TableFunctionManager, Column<double>, RowMultiplier, OutputColumn<double>)')
    def my_manager_error(mgr, col, m, out):
